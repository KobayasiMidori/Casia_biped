function out = FK_robot_left_V3(q1_temp,q2_temp,q3_temp,q4_temp,q5_temp,q6_temp,q7_temp)   
...
%     pRes=forwardKine_V3(q3,q4,q5,q6,q7,Para);
    ...
    Rz=[cos(-q2),-sin(-q2),0;sin(-q2),cos(-q2),0;0,0,1];
    Rx=[1,0,0;
    0,cos(q1),-sin(q1);
    0,sin(q1),cos(q1)];
    PD_now=Rx*Rz*PD_nor;
